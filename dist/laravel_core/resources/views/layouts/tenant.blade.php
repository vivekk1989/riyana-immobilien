        ...
        <aside :class="sidebarOpen ? 'translate-x-0' : '-translate-x-full'"
            ...
            <nav class="flex-1 p-4 space-y-2 overflow-y-auto">
                <a href="{{ route('dashboard') }}"
                    class="block px-4 py-2 rounded transition {{ request()->routeIs('dashboard') ? 'bg-slate-800 text-white' : 'text-slate-300 hover:bg-slate-800 hover:text-white' }}">
                    {{ __('Dashboard') }}
                </a>
                ...
                <a href="{{ route('tenant.utilities.index') }}"
                    class="block px-4 py-2 rounded transition {{ request()->routeIs('tenant.utilities.*') ? 'bg-slate-800 text-white' : 'text-slate-300 hover:bg-slate-800 hover:text-white' }}">
                    {{ __('Utilities') }}
                </a>
            </nav>
